...
const CARDS: CardDef[] = [
  ...
  },
  {
    ...
    subtopics: ['magnetism', 'geophysics', 'solar-wind'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['electromagnetism', 'faradays-law', 'electric-motors'],
    depth: 3,
  ...
  },
  {
    ...
    subtopics: ['nuclear-magnetic-resonance', 'superconductivity', 'medical-imaging'],
    depth: 4,
  ...
  {
    key: 'forgetting',
    title: "Your Brain Deletes Most of What You Learn on Purpose",
    ...
    subtopics: ['memory', 'forgetting-curve', 'learning'],
    depth: 1,
  ...
  },
  {
    ...
    subtopics: ['memory-consolidation', 'sleep', 'hippocampus', 'rem-sleep'],
    depth: 2,
  ...
  },
  {
    ...
    topics: ['psychology', 'science'],
    subtopics: ['spaced-repetition', 'learning', 'cognitive-science'],
    depth: 3,
  ...
  {
    key: 'why-things-fall',
    title: 'Gravity Is Not a Force — Einstein Proved It',
    ...
    topics: ['physics', 'science', 'space'],
    subtopics: ['gravity', 'general-relativity', 'newtonian-mechanics'],
    depth: 1,
  ...
  },
  {
    ...
    subtopics: ['gravity', 'orbital-mechanics', 'escape-velocity'],
    depth: 2,
  ...
  },
  {
    ...
    topics: ['physics', 'space', 'science'],
    subtopics: ['black-holes', 'general-relativity', 'time-dilation', 'spacetime'],
    depth: 3,
  ...
  },
  {
    ...
    topics: ['physics', 'space', 'science'],
    subtopics: ['event-horizon', 'hawking-radiation', 'information-paradox', 'quantum-gravity'],
    depth: 4,
  ...
  {
    key: 'what-dna-is',
    title: 'Two Meters of Instructions Folded Into Every Cell You Have',
    ...
    subtopics: ['dna', 'double-helix', 'genetics', 'molecular-biology'],
    depth: 1,
  ...
  },
  {
    ...
    title: 'Your Cells Are Running 40,000 Processes Right Now',
    ...
    topics: ['biology', 'science'],
    subtopics: ['transcription', 'mrna', 'ribosomes', 'protein-synthesis'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['crispr', 'gene-editing', 'cas9', 'genetic-engineering'],
    depth: 3,
  ...
  // ── Numbers (4) ────────────────────────────────────────────────────────────
  {
    ...
    subtopics: ['number-theory', 'zero', 'history-of-math'],
    depth: 1,
  ...
  },
  {
    ...
    subtopics: ['infinity', 'set-theory', 'cantors-theorem'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['prime-numbers', 'number-theory', 'cryptography'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['cryptography', 'rsa', 'public-key-encryption', 'quantum-computing'],
    depth: 3,
  ...
  // ── Light (3) ──────────────────────────────────────────────────────────────
  {
    ...
    topics: ['physics', 'science'],
    subtopics: ['optics', 'rayleigh-scattering', 'light'],
    depth: 1,
  ...
  },
  {
    ...
    topics: ['physics', 'science'],
    subtopics: ['optics', 'refraction', 'light-dispersion'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['optics', 'rayleigh-scattering', 'atmospheric-science'],
    depth: 2,
  ...
  // ── Evolution (3) ──────────────────────────────────────────────────────────
  {
    ...
    topics: ['biology', 'science'],
    subtopics: ['natural-selection', 'evolution', 'darwinism'],
    depth: 1,
  ...
  },
  {
    ...
    topics: ['biology', 'medicine', 'science'],
    subtopics: ['antibiotic-resistance', 'natural-selection', 'horizontal-gene-transfer', 'microbiology'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['mrsa', 'antibiotic-resistance', 'pathogens', 'hospital-infections'],
    depth: 3,
  ...
  // ── Sound (3) ──────────────────────────────────────────────────────────────
  {
    ...
    title: 'Sound Is Not a Thing — It\'s a Pattern of Panic in Air',
    ...
    topics: ['physics', 'science'],
    subtopics: ['acoustics', 'sound-waves', 'wave-mechanics'],
    depth: 1,
  ...
  },
  {
    ...
    subtopics: ['acoustics', 'reverberation', 'architectural-acoustics'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['auditory-system', 'cochlea', 'sound-transduction', 'neuroscience'],
    depth: 3,
  ...
  // ── Time (3) ───────────────────────────────────────────────────────────────
  {
    ...
    topics: ['physics', 'science', 'space'],
    subtopics: ['special-relativity', 'time-dilation', 'einsteins-relativity'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['general-relativity', 'special-relativity', 'gps', 'atomic-clocks'],
    depth: 3,
  ...
  },
  {
    ...
    subtopics: ['simultaneity', 'special-relativity', 'philosophy-of-time', 'block-universe'],
    depth: 4,
  ...
  {
    key: 'what-blood-does',
    title: 'Your Body Has a Liquid Organ and Most People Don\'t Know It',
    ...
    topics: ['biology', 'medicine', 'science'],
    subtopics: ['hematology', 'red-blood-cells', 'immune-system', 'circulatory-system'],
    depth: 1,
  ...
  {
    key: 'blood-types',
    title: 'The Wrong Blood Type Will Kill You in Minutes — Here\'s Why',
    ...
    topics: ['biology', 'medicine', 'science'],
    subtopics: ['blood-types', 'antigens', 'immunology', 'abo-system'],
    depth: 2,
  ...
  },
  {
    ...
    topics: ['medicine', 'biology', 'science'],
    subtopics: ['vaccines', 'immune-memory', 'mrna-vaccines', 'adaptive-immunity'],
    depth: 3,
  ...
  {
    key: 'what-fire-is',
    title: 'Fire Is Not a Thing — It\'s a Reaction Sustaining Itself',
    ...
    subtopics: ['combustion', 'oxidation', 'thermodynamics'],
    depth: 1,
  ...
  },
  {
    ...
    topics: ['physics', 'space', 'science'],
    subtopics: ['nuclear-fusion', 'stellar-physics', 'mass-energy-equivalence'],
    depth: 2,
  ...
  },
  {
    ...
    topics: ['physics', 'space', 'science'],
    subtopics: ['stellar-evolution', 'supernovae', 'white-dwarfs', 'neutron-stars'],
    depth: 3,
  ...
  {
    key: 'gold-as-money',
    title: 'Every Civilization Independently Decided Gold Was Special',
    ...
    subtopics: ['monetary-history', 'commodity-money', 'scarcity'],
    depth: 1,
  ...
  },
  {
    ...
    topics: ['economics', 'history'],
    subtopics: ['inflation', 'monetary-policy', 'macroeconomics'],
    depth: 2,
  ...
  },
  {
    ...
    subtopics: ['compound-interest', 'exponential-growth', 'personal-finance'],
    depth: 2,
...
async function insertTopics(postId: string, topics: string[], subtopics: string[] = []): Promise<void> {
  const rows = [
    ...topics.map(topic => ({ post_id: postId, topic, kind: 'topic' })),
    ...subtopics.map(topic => ({ post_id: postId, topic, kind: 'subtopic' })),
  ];
...
async function main() {
  ...
  for (const card of CARDS) {
    ...
    await insertTopics(id, card.topics, card.subtopics ?? []);
